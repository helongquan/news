...
(function() {
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, g, h, l) {
                function m(a, f, C, l) { a = { name: b, sender: this, editor: a, data: f, listenerData: h, stop: C, cancel: l, removeListener: r };
                    return !1 === d.call(g, a) ? !1 : a.data }

                function r() { C.removeListener(b, d) }
                var f = a.call(this, b);
                if (0 > f.getListenerIndex(d)) { f = f.listeners;
                    ...
                    for (var u = f.length - 1; 0 <= u; u--)
                        if (f[u].priority <= l) return f.splice(u + 1, 0, m), { removeListener: r };
                    f.unshift(m) }
                    ...
                    if (f) {
                        ...
                        if (u.length)
                            for (var u = u.slice(0), A, y = 0; y < u.length; y++) {
                                ...
                                } catch (q) {} else A = u[y].call(this, r, m, b, h);
                                !1 === A ? g = 1 : "undefined" != typeof A && (m = A);
                                if (a || g) break
                            }
                    }
    ...
    (function() {
        var a = [],
            ...
            l = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­" },
            m = function(a, f) {
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function(a, f) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c)) var q = "\x3c" + l + "\x3e",
                        m = "\x3c/" + l + "\x3e",
                        c = q + c.replace(d, function() {
                            return m + q }) + m }
                c = c.replace(/\n/g, "\x3cbr\x3e");
            ...
            setTimeout: function(a, f, b, c, l) {
                l || (l = window);
                b || (b = l);
                return l.setTimeout(function() { c ? a.apply(b, [].concat(c)) : a.apply(b) },
                    f || 0)
            },
            trim: function() {
                var a = /(?:^[ \t\n\r]+)|(?:[ \t\n\r]+$)/g;
            ...
            normalizeCssText: function(a, f) {
                var b = [],
                    c, l = CKEDITOR.tools.parseCssText(a, !0, f);
            ...
            normalizeHex: function(a) {
                return a.replace(/#(([0-9a-f]{3}){1,2})($|;|\s+)/gi, function(a, b, c, l) { a = b.toLowerCase();
            ...
            parseCssText: function(a, b, c) {
                ...
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
                    function(a, c, q) { b && (c = c.toLowerCase(), "font-family" == c && (q = q.replace(/\s*,\s*/g, ",")), q = CKEDITOR.tools.trim(q));
                        l[c] = q });
                return l
            },
            ...
            eventsBuffer: function(a, b, c) {
                ...
                return { input: function() {
                        if (!d) {
                            ...
                            b < a ? d = setTimeout(l, a - b) : l() } }, reset: function() { d && clearTimeout(d);
                        d = m = 0 } } },
            ...
            keystrokeToString: function(a, b) {
                var c = b & 16711680,
                    ...
                    m = [],
                    q = [];
                c & CKEDITOR.CTRL && (m.push(d ? "⌘" : a[17]), q.push(d ? a[224] : a[17]));
                c & CKEDITOR.ALT && (m.push(d ? "⌥" : a[18]), q.push(a[18]));
                c & CKEDITOR.SHIFT && (m.push(d ? "⇧" : a[16]), q.push(a[16]));
                l && (a[l] ? (m.push(a[l]), q.push(a[l])) : (m.push(String.fromCharCode(l)), q.push(String.fromCharCode(l))));
                return { display: m.join("+"), aria: q.join("+") }
            },
            ...
            getCookie: function(a) {
                ...
                for (var b = document.cookie.split(";"), c, l, d = 0; d < b.length; d++)
                    if (c = b[d].split("\x3d"), l = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), l === a) return decodeURIComponent(1 < c.length ? c[1] : "");
                return null
            },
            ...
            style: {
                parse: {
                    ...
                    margin: function(a) {
                        function b(a) { c.top = l[a[0]];
                            c.right = l[a[1]];
                            c.bottom = l[a[2]];
                            c.left = l[a[3]] }
                        var c = {},
                            l = a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset)/g) || ["0px"];
                        switch (l.length) {
                            case 1:
                                b([0, 0, 0, 0]);
                                break;
            ...
            array: { filter: function(a, b, c) {
                    var l = [];
                    this.forEach(a, function(d, m) { b.call(c, d, m, a) && l.push(d) });
                    return l }, forEach: function(a, b, c) {
                    var l = a.length,
                        d;
                    for (d = 0; d < l; d++) b.call(c, a[d], d, a) } }
        };
    ...
    CKEDITOR.dtd = function() {
        var a = CKEDITOR.tools.extend,
            d = function(a, b) {
                for (var c = CKEDITOR.tools.clone(a), l = 1; l < arguments.length; l++) { b = arguments[l];
    ...
    (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var e = this.$.getBoundingClientRect(),
                        g = f.$.documentElement,
                        q = g.clientTop || d.$.clientTop || 0,
                        x = g.clientLeft || d.$.clientLeft || 0,
                        h = !0;
                    CKEDITOR.env.ie && (h = f.getDocumentElement().contains(this), f = f.getBody().contains(this), h = u && f || !u && h);
                    h && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft, c = d.$.scrollTop || g.scrollTop) : (c = u ? d.$ : g, b = c.scrollLeft, c = c.scrollTop), b = e.left + b - x, c = e.top + c - q) } else
                    for (q = this, x = null; q && "body" != q.getName() &&
                        "html" != q.getName();) { b += q.$.offsetLeft - q.$.scrollLeft;
                        c += q.$.offsetTop - q.$.scrollTop;
                        q.equals(this) || (b += q.$.clientLeft || 0, c += q.$.clientTop || 0);
                        for (; x && !x.equals(q);) b -= x.$.scrollLeft, c -= x.$.scrollTop, x = x.getParent();
                        x = q;
                        q = (e = q.$.offsetParent) ? new CKEDITOR.dom.element(e) : null }
                a && (e = this.getWindow(), q = a.getWindow(), !e.equals(q) && e.$.frameElement && (a = (new CKEDITOR.dom.element(e.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                A = d.y - x(this, "top") - w.y || 0;
                f = d.x + f + x(this, "right") - (w.x + p) || 0;
                d = d.y + E + x(this, "bottom") - (w.y + k) || 0;
                (0 > A || 0 < d) && g(0, !0 === b ? A : !1 === b ? d : 0 > A ? A : d);
    ...
    (function() {
        function a(a, b) {
            ...
            if (!a && !this._.guardLTR) {
                var t = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(),
                    z = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(C) : f.getNext();
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function(a, b) {
                    return (!b || !B.equals(a)) && (!h || !a.equals(h)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) } }
            var L = a ? this._.guardRTL : this._.guardLTR;
            g = k ? function(a, b) {
                return !1 === L(a, b) ? !1 : k(a, b) } : L;
            this.current ? f = this.current[n](!1, p, g) : (a ? f.type == CKEDITOR.NODE_ELEMENT &&
                (f = 0 < C ? f.getChild(C - 1) : !1 === g(f, !0) ? null : f.getPreviousSourceNode(!0, p, g)) : (f = d, f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === g(d, !0) ? null : d.getNextSourceNode(!0, p, g)))), f && !1 === g(f) && (f = null));
        ...
        CKEDITOR.dom.walker.ignored =
            function(a) {
                return function(b) { b = g(b) || h(b) || l(b);
                    return !!(a ^ b) } };
        ...
        CKEDITOR.dom.walker.editable = function(a) {
            return function(b) {
                b =
                    r(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(C) && f(b)) ? !0 : !1;
                return !!(a ^ b)
            }
        };
    ...
    (function() {
        ...
        function d(a, b, c, d, e) {
            function q(a, b, c, f) {
                ...
                if (f && l) return d;
                k || f ? b.append(a.clone(!0, e), c) : (a.remove(), r && b.append(a));
                return d }
            ...
            function h() {
                var b = G - 1,
                    c = L && H && !p.equals(n);
                b < D - 1 || b < I - 1 || c ? (c ? a.moveToPosition(n,
            ...
            var p = a.startContainer,
                ...
                z = a.endOffset,
                B, F, L, H, m, Q;
            if (k && n.type == CKEDITOR.NODE_TEXT && p.equals(n)) p = a.document.createText(p.substring(t, z)), c.append(p);
            else {
                n.type == CKEDITOR.NODE_TEXT ? k ? Q = !0 : n = n.split(z) : 0 < n.getChildCount() ? z >= n.getChildCount() ? (n = n.getChild(z - 1), F = !0) : n = n.getChild(z) : H = F = !0;
                p.type == CKEDITOR.NODE_TEXT ? k ? m = !0 : p.split(t) : 0 < p.getChildCount() ? 0 === t ? (p = p.getChild(t), B = !0) : p = p.getChild(t - 1) : L = B = !0;
                for (var P = p.getParents(), v = n.getParents(), G = g(), D = P.length - 1, I = v.length - 1, K = c, M, Z, X, fa = -1, S = G; S <= D; S++) {
                    Z =
                        P[S];
                    X = Z.getNext();
                    for (S != D || Z.equals(v[S]) && D < I ? b && (M = K.append(Z.clone(0, e))) : B ? q(Z, K, !1, L) : m && K.append(a.document.createText(Z.substring(t))); X;) {
                ...
                for (S = G; S <= I; S++)
                    ...
                    else { S != I || c.equals(P[S]) && I < D ? b && (M = K.append(c.clone(0, e))) : F ? q(c, K, !1, H) : Q && K.append(a.document.createText(c.substring(0, z)));
                        if (S > fa)
                            for (; X;) X = q(X, K, !0);
                        K = M }
                k || h()
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        z.type == CKEDITOR.NODE_TEXT ? (F && (z = !CKEDITOR.tools.trim(z.substring(0, F)).length && z, t = !!z), z && ((p = z.getPrevious()) || (k = z.getParent()))) : (F && (p = z.getChild(F - 1) || z.getLast()), p || (k = z));
                        for (k = c(k); k || p;) {
                            if (k && !p) {
                                !n && k.equals(g) && (n = !0);
                                if (e ? k.isBlockBoundary() :
                                    !h.contains(k)) break;
                                t && "inline" == k.getComputedStyle("display") || (t = !1, n ? l = k : this.setStartBefore(k));
                                p = k.getPrevious()
                            }
                            for (; p;)
                                if (z = !1, p.type == CKEDITOR.NODE_COMMENT) p = p.getPrevious();
                                else {
                                    if (p.type == CKEDITOR.NODE_TEXT) B = p.getText(), d.test(B) && (p = null), z = /[\s\ufeff]$/.test(B);
                                        ...
                                        if (t && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            ...
                                            if (d.test(B)) p = null;
                                                ...
                                                for (var F = p.$.getElementsByTagName("*"), L = 0, H; H =
                                                    F[L++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[H.nodeName.toLowerCase()]) { p = null;
                                                        break }
                                            p && (z = !!B.length)
                                        } else p = null;
                                    z && (t ? n ? l = k : k && this.setStartBefore(k) : t = !0);
                                    if (p) { z = p.getPrevious();
                                        if (!k && !z) { k = p;
                                            p = null;
                                            break }
                                        p = z } else k = null
                        ...
                        k = p = null;
                        n = t = !1;
                        z.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(z.substring(F)).length ? t = !0 : (t = !z.getLength(), F == z.getLength() ? (p = z.getNext()) || (k = z.getParent()) : q(z, F) && (k = z.getParent())) : (p = z.getChild(F)) || (k = z);
                        for (; k ||
                            p;) {
                            if (k && !p) {!n && k.equals(g) && (n = !0);
                                if (e ? k.isBlockBoundary() : !h.contains(k)) break;
                                t && "inline" == k.getComputedStyle("display") || (t = !1, n ? r = k : k && this.setEndAfter(k));
                                p = k.getNext() }
                            for (; p;) {
                                z = !1;
                                if (p.type == CKEDITOR.NODE_TEXT) B = p.getText(), q(p, 0) || (p = null), z = /^[\s\ufeff]/.test(B);
                        ...
                        l && r && (g = l.contains(r) ? r : l, this.setStartBefore(g), this.setEndAfter(g));
                        break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var m, Q, P = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            v = null,
                            G = function(a) {
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { k = this.clone();
                            k = new CKEDITOR.dom.walker(k);
                        ...
                        k = new CKEDITOR.dom.walker(k);
                        k.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? e : G;
                        m = v = Q = null;
                        k = k.lastForward();
                        m = m || h;
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    q && q.type == CKEDITOR.NODE_TEXT && (h ? h >= q.getLength() ? d.setEndAfter(q) :
                        (d.setEndAfter(q), r = 0) : d.setEndBefore(q));
            ...
            moveToElementEditablePosition: function(a, b) {
                ...
                for (var c = 0; a;) {
                    ...
                    var d = a,
                        e = c,
                        q = void 0;
                    d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (q = d[b ? "getLast" : "getFirst"](r));
                    e || q || (q = d[b ? "getPrevious" : "getNext"](r));
                    a = q
                }
                return !!c
            },
            moveToClosestEditablePosition: function(a, b) {
                var c, d = 0,
                    e, q, g = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
                a ? (c = new CKEDITOR.dom.range(this.root), c.moveToPosition(a, g[b ? 0 : 1])) : c = this.clone();
                if (a && !a.is(CKEDITOR.dtd.$block)) d = 1;
                else if (e = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]()) d = 1, (q = e.type == CKEDITOR.NODE_ELEMENT) &&
            ...
            _find: function(a, b) {
                ...
                if (c && c.find)
                    for (g = c.find(a), q = 0; q < g.count(); q++)
                        if (c = g.getItem(q), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), l = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED,
                            h && l && e.push(c);
                return e
            }
        }
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                if (!this._.started) {
                    ...
                    h = q.startPath();
                    var x = q.endPath(),
                        J = !q.collapsed && c(q, h.block),
                        w = !q.collapsed && c(q, x.block, 1);
                    q.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
                    J && q.setStartAt(h.block, CKEDITOR.POSITION_BEFORE_END);
                    w && q.setEndAt(x.block, CKEDITOR.POSITION_AFTER_START);
                    h = q.endContainer.hasAscendant("pre", !0) || q.startContainer.hasAscendant("pre", !0);
                    ...
                    q.collapsed || (h = new CKEDITOR.dom.walker(q.clone()), x = CKEDITOR.dom.walker.bookmark(!0, !0), h.evaluator = x, this._.nextNode = h.next(), h = new CKEDITOR.dom.walker(q.clone()), h.evaluator = x, h = h.previous(), this._.lastNode = h.getNextSourceNode(!0, null, q.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (x = this.range.clone(), x.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), x.checkEndOfBlock() &&
                        (x = new CKEDITOR.dom.elementPath(x.endContainer, x.root), this._.lastNode = (x.block || x.blockLimit).getNextSourceNode(!0))), this._.lastNode && q.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = q.document.createText(""), this._.lastNode.insertAfter(h)), q = null);
                    this._.started = 1;
                    h = q
                }
                x = this._.nextNode;
                ...
                for (this._.nextNode = null; x;) {
                    var J = 0,
                        ...
                        E = x.type != CKEDITOR.NODE_ELEMENT,
                        k = 0;
                    if (E) x.type == CKEDITOR.NODE_TEXT && e.test(x.getText()) && (E = 0);
                    else {
                        var p = x.getName();
                        if (CKEDITOR.dtd.$block[p] && "false" == x.getAttribute("contenteditable")) { d = x;
                            b(this, a, d);
                            break } else if (x.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) {
                            if ("br" == p) E = 1;
                            else if (!h && !x.getChildCount() && "hr" != p) { d = x;
                                u = x.equals(q);
                                break }
                            h && (h.setEndAt(x, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = x));
                            J = 1 } else {
                            if (x.getFirst()) { h || (h = this.range.clone(), h.setStartAt(x, CKEDITOR.POSITION_BEFORE_START));
                                x = x.getFirst();
                                continue }
                            E = 1 }
                    }
                    ...
                    u = (!J || E) && x.equals(q);
                    if (h && !J)
                        for (; !x.getNext(l) && !u;) { p = x.getParent();
                            if (p.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { J = 1;
                                E = 0;
                                u || p.equals(q);
                            ...
                            u = x.equals(q);
                            k = 1 }
                    E && h.setEndAt(x, CKEDITOR.POSITION_AFTER_END);
                    x = this._getNextSourceNode(x, k, q);
                    if ((u = !x) || J && h) break
                }
                if (!d) {
                ...
                y && (A = d.getLast()) && A.type == CKEDITOR.NODE_ELEMENT && "br" == A.getName() && (!CKEDITOR.env.needsBrFiller || A.getPrevious(g) || A.getNext(g)) && A.remove();
                this._.nextNode || (this._.nextNode = u || d.equals(q) || !q ? null : this._getNextSourceNode(d, 1, q));
                return d
            },
    ...
    (function() {
        function a(a, b, c, d, k) {
            ...
            for (e in b) {
                p = b[e];
                p = "boolean" == typeof p ? {} : "function" == typeof p ? { match: p } : L(p);
                ...
                for (t in Q) {
                    ...
                    var q = n,
                        ...
                        B = void 0;
                    D ? I = !1 : D = {};
                    for (B in v) "!" == B.charAt(0) && (B = B.slice(1), z.push(B), D[B] = !0, I = !1);
                    for (; B = z.pop();) v[B] =
                        v["!" + B], delete v["!" + B];
                    q[g] = (I ? !1 : D) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (t in P) { f = P[t];
                    ...
                    D = [];
                    v = void 0;
                    for (v in g) - 1 < v.indexOf("*") ? D.push(new RegExp("^" + v.replace(/\*/g, ".*") + "$")) : D.push(v);
                    g = D;
                    g.length && (n[f] = g, q = !1) }
                n.nothingRequired = q;
                n.noProperties = !(n.attributes || n.classes || n.styles);
                if (!0 === e.elements ||
                    null === e.elements) k[p ? "unshift" : "push"](e);
                else
                    for (l in n = e.elements, delete e.elements, n)
                        if (b[l]) b[l][p ? "unshift" : "push"](e);
                        else b[l] = [e]
            }
        }
        ...
        function l(a, b) {
            ...
            if (k = a.requiredClasses)
                for (e = b.classes, c = 0; c < k.length; ++c)
        ...
        function f(a) {
            var b, c, d, k, e = {},
                p = 1;
            for (a = H(a); b = a.match(v);)(c = b[2]) ? (d = C(c, "styles"), k = C(c, "attrs"), c = C(c, "classes")) : d = k = c = null, e["$" + p++] = { elements: b[1], classes: c, styles: d, attributes: k }, a = a.slice(b[0].length);
            return e }
        ...
        function A(a, b, k, e) {
            var n = 0,
                f;
            e.toHtml && (b.name = b.name.replace(D, "$1"));
            ...
            if (e.doTransform && (f = a._.transformations[b.name])) { u(b);
                for (t = 0; t < f.length; ++t) p(a, b, f[t]);
                q(b) }
            if (e.doFilter) {
                a: {
                    ...
                    v = e.skipRequired;
                    var h = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 },
                        z, B;
                    if (a || f) { u(b);
                        if (t)
                            for (z = 0, B = t.length; z < B; ++z)
                                if (!1 === c(t[z], b, h)) { a = null;
                                    break a }
                        if (g)
                            for (z = 0, B = g.length; z < B; ++z) c(g[z], b, h);
                        if (a)
                            for (z = 0, B = a.length; z < B; ++z) d(a[z], b, h, v);
                        if (f)
                            for (z = 0, B = f.length; z < B; ++z) d(f[z], b, h, v);
                        a = h } else a = null
                }
                if (!a || !a.valid) return k.push(b), 1;B = a.validAttributes;
                var l = a.validStyles;
                f = a.validClasses;
                var t = b.attributes,
                    L = b.styles,
                ...
                var K = b.styleBackup,
                    G, F, m = [],
                    h = [],
                    H = /^data-cke-/;z = !1;delete t.style;delete t["class"];delete b.classBackup;delete b.styleBackup;
                if (!a.allAttributes)
                    for (G in t) B[G] || (H.test(G) ? G == (F = G.replace(/^data-cke-saved-/, "")) || B[F] || (delete t[G], z = !0) : (delete t[G], z = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (G in L) a.allStyles || l[G] ? m.push(G + ":" + L[G]) : z = !0;
                    m.length && (t.style = m.sort().join("; ")) } else K && (t.style = K);
                if (!a.allClasses ||
                    a.hadInvalidClass) {
                    for (G = 0; G < g.length; ++G)(a.allClasses || f[g[G]]) && h.push(g[G]);
                    h.length && (t["class"] = h.sort().join(" "));
                    v && h.length < v.split(/\s+/).length && (z = !0) } else v && (t["class"] = v);z && (n = 1);
                if (!e.skipFinalValidation && !x(b)) return k.push(b), 1
            }
        ...
        function E(a) {
            return a.type == CKEDITOR.NODE_ELEMENT && ("br" ==
                a.name || F.$block[a.name])
        }

        function k(a, b, c) {
            var d = a.name;
            if (F.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(w()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
            else if (F.$block[d] || "tr" == d)
                if ("br" == b) a.previous && !E(a.previous) && (b = w(), b.insertBefore(a)), a.next && !E(a.next) && (b = w(), b.insertAfter(a)), a.replaceWithChildren();
                else {
                    var d = a.children,
                        k;
                    b: { k = F[b];
                        for (var e = 0, p = d.length, n; e < p; ++e)
                            if (n = d[e], n.type == CKEDITOR.NODE_ELEMENT && !k[n.name]) { k = !1;
                                break b }
                        k = !0 }
                    if (k) a.name = b, a.attributes = {}, c.push({ check: "parent-down", el: a });
                    else { k = a.parent;
                        for (var e = k.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == k.name, t, f, p = d.length; 0 < p;) n = d[--p], e && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && F.$inline[n.name]) ? (t || (t = new CKEDITOR.htmlParser.element(b), t.insertAfter(a), c.push({ check: "parent-down", el: t })), t.add(n, 0)) : (t = null, f = F[k.name] || F.span, n.insertAfter(a), k.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || f[n.name] || c.push({ check: "el-up", el: n }));
                        a.remove() }
                }
        ...
        function p(a, b, c) {
            ...
            for (d = 0; d < c.length; ++d)
                if (k = c[d], !(k.check && !a.check(k.check, !1) || k.left && !k.left(b))) { k.right(b, K);
                    break } }
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                if ("string" == typeof b) b = f(b);
                    ...
                    b = {};
                    d = k.attributes;
                    b[k.element] = k = { styles: k.styles, requiredStyles: k.styles && CKEDITOR.tools.objectKeys(k.styles) };
                    d && (d =
            ...
            applyTo: function(a, b, c, d) {
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        a: {
                            ...
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);1 == d.children.length && (k = d.children[0]).type == CKEDITOR.NODE_ELEMENT && A(e, k, c, g);c = !c.length
                        }
                        c || p.push(a)
                    }
                }, null, !0);
                ...
                for (var D; c = p.pop();) c.type == CKEDITOR.NODE_ELEMENT ? k(c, d, a) : c.remove();
                for (; q = a.pop();)
                    if (c = q.el, c.parent) switch (D = F[c.parent.name] || F.span, q.check) {
                        case "it":
                            F.$removeEmpty[c.name] && !c.children.length ? k(c, d, a) : x(c) || k(c, d, a);
                            break;
                        case "el-up":
                            c.parent.type ==
                                CKEDITOR.NODE_DOCUMENT_FRAGMENT || D[c.name] || k(c, d, a);
                            break;
                        case "parent-down":
                            c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || D[c.name] || k(c.parent, d, a)
                    }
                    return f
            },
            ...
            addContentForms: function(a) {
                if (!this.disabled && a) {
                    ...
                    if (k) {
                        for (b = 0; b < a.length; ++b) d.push(t(a[b], k));
                ...
                if (!this.disabled && a) {
                    ...
                    for (k = 0; k < a.length; ++k) {
                        ...
                        var e = void 0,
                            ...
                            g = void 0;
                        c = [];
                        for (p = 0; p < b.length; ++p) n = b[p], "string" == typeof n ? (n = n.split(/\s*:\s*/), t = n[0], f = null, g = n[1]) : (t = n.check, f = n.left, g = n.right), e || (e = n, e = e.element ? e.element : t ? t.match(/^([a-z0-9]+)/i)[0] :
                            e.left.getDefinition().element), f instanceof CKEDITOR.style && (f = z(f)), c.push({ check: t == e ? null : t, left: f, right: "string" == typeof g ? B(g) : g });
                        b = e;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                    }
            ...
            check: function(a, b, c) {
                ...
                if ("string" == typeof a) {
                    ...
                    k = d
                } else d = a.getDefinition(), k = d.styles, n = d.attributes || {}, k && !CKEDITOR.tools.isEmpty(k) ? (k = L(k), n.style = CKEDITOR.tools.writeCssText(k, !0)) : k = {}, k = { name: d.element, attributes: n, classes: n["class"] ? n["class"].split(/\s+/) : [], styles: k, children: [] };
                var n = CKEDITOR.tools.clone(k),
                    t = [],
                    g;
                if (!1 !== b && (g = this._.transformations[k.name])) {
                    for (d =
                        0; d < g.length; ++d) p(this, k, g[d]);
                    q(k)
                }
                A(this, n, t, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c });
            ...
            transform: function(a, b) {
                if ("string" == typeof b) a.name = b;
                    ...
                    for (e in k)
                        if ("class" ==
                            e)
                            for (c = a.classes.join("|"), n = k[e].split(/\s+/); t = n.pop();) - 1 == c.indexOf(t) && a.classes.push(t);
    ...
    (function() {
        ...
        CKEDITOR.focusManager.prototype = {
            ...
            blur: function(a) {
                function d() {
                    if (this.hasFocus) { this.hasFocus = !1;
        ...
        return {
            load: function(b, c, e, g) {
                ...
                var l = b.length,
                    m = [],
                    r = [],
                    f = function(a) { c && (h ? c.call(e, a) : c.call(e, m, r)) };
                if (0 === l) f(!0);
                else {
                    var C = function(a, b) {
                            (b ? m : r).push(a);
        ...
        load: function(a, d, b) {
            ...
            CKEDITOR.scriptLoader.load(g, function(a, e) {
                ...
                for (var f = 0; f < a.length; f++)
                    for (var g = h[a[f]], q = 0; q < g.length; q++) {
                        var x = g[q];
                        l[x] = this.get(x);
                        c[x] = 1 }
                d.call(b, l) }, this)
                ...
                h = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (f in a) {
                            ...
                            if (!d[f]) {
                                if (l.icons)
                                    for (var A = l.icons.split(","), y = A.length; y--;) CKEDITOR.skin.addIcon(A[y], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + A[y] + ".png");
                                d[f] = 1 }
                            if (u)
                                for (u.split && (u = u.split(",")), l = 0; l < u.length; l++) g[u[l]] || b.push(u[l]) }
    ...
    (function() {
        function a(a, e, f) {
            ...
            CKEDITOR.add(this);
            CKEDITOR.tools.setTimeout(function() { "destroyed" !== this.status ? l(this, a) : CKEDITOR.warn("editor-incorrect-destroy") }, 0, this)
        }

        function d() { do var a = "editor" + ++A; while (CKEDITOR.instances[a]);
            return a }
        ...
        function h(a) {
            ...
            var b =
                CKEDITOR.getUrl(b),
                c = y[b] || (y[b] = {});
            c.fn ? (c.fn.call(a, a.config), CKEDITOR.getUrl(a.config.customConfig) != b && h(a) || a.fireOnce("customConfigLoaded")) : CKEDITOR.scriptLoader.queue(b, function() { c.fn = CKEDITOR.editorConfig ? CKEDITOR.editorConfig : function() {};
                h(a) });
            return !0
        }
        ...
        function C(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var f in c) {
                    ...
                    if (m && (r = m.match(p)))
                        for (; m = r.pop();) CKEDITOR.error("editor-plugin-required", { plugin: m.replace(",", ""), requiredBy: f });
                    h && !a.lang[f] && (h.split && (h = h.split(",")), 0 <= CKEDITOR.tools.indexOf(h, a.langCode) ? l = a.langCode : (l = a.langCode.replace(/-.*/, ""), l = l != a.langCode && 0 <= CKEDITOR.tools.indexOf(h, l) ? l : 0 <= CKEDITOR.tools.indexOf(h, "en") ? "en" : h[0]), g.langEntries && g.langEntries[l] ? (a.lang[f] = g.langEntries[l], l = null) : e.push(CKEDITOR.getUrl(g.path + "lang/" + l + ".js")));
                    k.push(l);
                    d.push(g)
                }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            getSelectedHtml: function(a) {
                ...
                for (var d = new CKEDITOR.dom.documentFragment, e, k, p, n = 0; n < c.length; n++) {
                    var f = c[n],
                        g = f.startContainer;
                    g.getName && "tr" == g.getName() ? (e || (e = g.getAscendant("table").clone(), e.append(g.getAscendant("tbody").clone()), d.append(e), e = e.findOne("tbody")), k && k.equals(g) || (k = g, p = g.clone(), e.append(p)), p.append(f.cloneContents())) : d.append(f.cloneContents()) }
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var c, e, g = 0, h; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (e = c[1])
                        if (e = e.toLowerCase(), h && CKEDITOR.dtd.$cdata[e] && (this.onCDATA(h.join("")), h = null), !h) { this.onTagClose(e);
                            continue }
                    if (h) h.push(c[0]);
                    else if (e = c[3]) {
                        if (e = e.toLowerCase(), !/="/.test(e)) {
                            ...
                            this.onTagOpen(e, l, c);!h && CKEDITOR.dtd.$cdata[e] && (h = []) } } else if (e = c[2]) this.onComment(e)
                }
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(g, h, l) {
                function m(a) {
                    ...
                    if (0 < x.length)
                        for (var c = 0; c < x.length; c++) {
                            ...
                            f && !f[k] || a && e && !e[a] && CKEDITOR.dtd[a] ? k == w.name && (C(w, w.parent, 1), c--) : (b || (r(), b = 1), d = d.clone(), d.parent = w, w = d, x.splice(c, 1), c--) } }

                function r() {
                    for (; J.length;) C(J.shift(), w) }
                ...
                function C(b, c, d) { c = c || w || q;
                    var e = w;
                    void 0 === b.previous && (u(c, b) && (w = c, y.onTagOpen(l, {}), b.returnPoint = c = w), f(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (k = !1), "textarea" == b.name && (E = !1));
                ...
                var y = new CKEDITOR.htmlParser,
                    q = h instanceof CKEDITOR.htmlParser.element ? h : "string" == typeof h ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment,
                    x = [],
                    J = [],
                    w = q,
                    E = "textarea" == q.name,
                ...
                y.onTagOpen = function(e, n, f, g) {
                    ...
                    if (a(n)) x.push(n);
                        ...
                        if ("pre" == e) k = !0;
                            ...
                            if ("br" == e && k) { w.add(new CKEDITOR.htmlParser.text("\n"));
                                return } "textarea" == e && (E = !0) }
                        if ("br" == e) J.push(n);
                        else {
                            for (; !(g = (f = w.name) ? CKEDITOR.dtd[f] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, n.isUnknown || w.isUnknown || g[e]);)
                                ...
                                else if (e in b && f in b) f = w.children, (f = f[f.length - 1]) && "li" == f.name || C(f = new CKEDITOR.htmlParser.element("li"), w), !n.returnPoint && (n.returnPoint = w), w = f;
                            else if (e in CKEDITOR.dtd.$listItem &&
                                !A(e, f)) y.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
                            else if (f in d && !A(e, f)) !n.returnPoint && (n.returnPoint = w), w = w.parent;
                            else if (f in CKEDITOR.dtd.$inline && x.unshift(w), w.parent) C(w, w.parent, 1);
                            else { n.isOrphan = 1;
                                break }
                            m(e);
                            r();
                ...
                y.onTagClose = function(a) {
                    for (var b = x.length - 1; 0 <= b; b--)
                        if (a == x[b].name) { x.splice(b, 1);
                            return }
                    for (var c = [], d = [], k = w; k != q && k.name != a;) k._.isBlockLike || d.unshift(k), c.push(k), k = k.returnPoint || k.parent;
                    if (k != q) {
                ...
                y.onText = function(a) {
                    if (!(w._.hasInlineStarted && !J.length || k || E) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
                    var b = w.name,
                        f = b ? CKEDITOR.dtd[b] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                    if (!E && !f["#"] && b in d) y.onTagOpen(e[b] || ""), y.onText(a);
                    else { r();
                        m();
                        k || E || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a);
                        if (u(w, a)) this.onTagOpen(l, {}, 0, 1);
                        w.add(a) } };
                y.onCDATA =
    ...
    (function() {
        ...
        a.prototype = {
            ...
            addMany: function(a,
                c, d) {
                for (var g = [this.findIndex(c), 0], h = 0, l = a.length; h < l; h++) g.push({ value: a[h], priority: c, options: d });
    ...
    (function() {
        function a(a, d) {
                ...
                return function(k) {
                    if (k.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var e = [],
                            ...
                            t, D;
                        if (n)
                            for (p(n, 1) && e.push(n); n;) g(n) && (t = c(n)) && p(t) && ((D = c(t)) && !g(D) ? e.push(t) : (f(v).insertAfter(t), t.remove())), n = n.previous;
                        for (n = 0; n < e.length; n++) e[n].remove();
                        if (e = !a || !1 !== ("function" == typeof d ? d(k) : d)) v || CKEDITOR.env.needsBrFiller ||
                            k.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? v || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || k.name in CKEDITOR.dtd.tr || k.name in CKEDITOR.dtd.$listItem) ? (e = b(k), e = !e || "form" == k.name && "input" == e.name) : e = !1 : e = !1;
                        e && k.add(f(a))
                    }
                }
            }
            ...
            var t = { elements: {} },
                v = "html" == d,
                z = CKEDITOR.tools.extend({}, k),
                B;
            for (B in z) "#" in w[B] || delete z[B];
            for (B in z) t.elements[B] = n(v, a.config.fillEmptyBlocks);
            t.root = n(v, !1);
        ...
        function l(a) { a = a.attributes; "false" != a.contenteditable && (a["data-cke-editable"] = a.contenteditable ? "true" : 1);
            a.contenteditable = "false" }

        function m(a) { a = a.attributes;
            ...
            return a.replace(B,
                function(a, b, c) {
                    return "\x3c" + b + c.replace(F, function(a, b) {
                        return L.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" })
        }

        function f(a, b) {
            return a.replace(b, function(a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + A(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e");
        ...
        function q(a, b) {
            var c = [],
                ...
                k = b._.dataStore || (b._.dataStore = { id: 1 }),
            ...
            a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function(a) {
                return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function(a, b) { k[k.id] = decodeURIComponent(b);
                    return "{cke_protected_" + k.id++ + "}" }) });
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, k) {
                return "\x3c" + c + d + "\x3e" + y(A(k), b) + "\x3c/" + c + "\x3e" })
        }
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function(a, b, c, d) {
                var k = this.editor,
                    e, f, n, p;
                b && "object" == typeof b ? (e = b.context, c = b.fixForBody, d = b.dontFilter, f = b.filter, n = b.enterMode, p = b.protectedWhitespaces) : e = b;
            ...
            toDataFormat: function(a, b) {
                ...
                return this.editor.fire("toDataFormat", { dataValue: a, filter: d || this.editor.filter, context: c, enterMode: k || this.editor.enterMode }).dataValue }
        };
        var x = /(?:&nbsp;|\xa0)$/,
            J = "{cke_protected}",
            w = CKEDITOR.dtd,
            E = "caption colgroup col thead tfoot tbody".split(" "),
            k = CKEDITOR.tools.extend({}, w.$blockLimit,
                w.$block),
            p = { elements: { input: l, textarea: l } },
            n = { attributeNames: [
                    [/^on/, "data-cke-pa-on"],
                    [/^data-cke-expando$/, ""]
                ] },
                ...
                elements: {
                    ...
                    table: function(a) {
                        a.children.slice(0).sort(function(a, b) {
                            var c, d;
                            a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(E, a.name), d = CKEDITOR.tools.indexOf(E, b.name)); - 1 < c && -1 < d && c != d || (c = a.parent ? a.getIndex() : -1, d = b.parent ? b.getIndex() : -1);
                            return c > d ?
                                1 : -1
                        })
                    },
    ...
    (function() {
        function a(a, e, g, h) {
            ...
            l.on("loaded", function() {
                ...
                l.setMode(l.config.startupMode, function() { l.resetDirty();
                    l.status = "ready";
            ...
            for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) {
                ...
                if (h.name || h.id) {
                    if ("string" == typeof arguments[0]) {
                        if (!(new RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)")).test(h.className)) continue } else if ("function" == typeof arguments[0] && (d = {}, !1 === arguments[0](h, d))) continue;
                    this.replace(h, d) } } };
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && h && h[a]) {
                ...
                if (d.mode) {
                    ...
                    d._.previousModeData = m = d.getData(1); "source" == d.mode && h == m && (d.fire("lockSnapshot", { forceUpdate: !0 }), r = 1);
        ...
        CKEDITOR.editor.prototype.resize = function(a, b, d, h) {
            ...
            h = h ? this.container.getFirst(function(a) {
                return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }) : l;
            h.setSize("width", a, !0);
            r && (r.style.width = "1%");
    ...
    (function() {
        function a(a) {
            ...
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)
                if (g = d(g, e)) g.appendBogus(), l = CKEDITOR.env.ie;
            h(b, e.block, f) && B.collapsed && !B.getCommonAncestor().isReadOnly() && (e = B.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(e), f.guard = function(a) {
                    return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly() }, !f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
                (b = B.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), l = 1, a.cancel());
            l && B.select()
        }
        ...
        function g(a) {
            function b(a) {
                return function(b, k) { k && b.type == CKEDITOR.NODE_ELEMENT && b.is(f) && (d = b);
                    if (!(k || !c(b) || a && A(b))) return !1 } }
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertHtmlIntoRange: function(a, b, c) { q(this, c || "html", a, b);
                ...
                insertElement: function(a, b) {
                    ...
                    this.insertElementIntoRange(a, b) && (b.moveToPosition(a,
                        ...
                        return c(a) && !A(a) })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div" : "p"), b.moveToElementEditStart(f))));
                    d.selectRanges([b]);
                    m(this)
                },
                ...
                fixInitialSelection: function() {
                    function a() {
                        ...
                        a: if (d.anchorNode && d.anchorNode == c.$) k = !0;
                                ...
                                if (CKEDITOR.env.webkit && (k = c.getDocument().getActive()) && k.equals(c) && !d.anchorNode) { k = !0;
                                    break a }
                                k = void 0 }
                    ...
                    function b() {
                        var a = c.getDocument().$,
                            d = a.selection,
                            k = c.getDocument().getActive(); "None" == d.type && k.equals(c) && (d = new CKEDITOR.dom.range(c), a = a.body.createTextRange(), d.moveToElementEditStart(c), d = d.startContainer, d.type != CKEDITOR.NODE_ELEMENT && (d = d.getParent()), a.moveToElementText(d.$), a.collapse(!0), a.select()) }
                    var c = this;
                ...
                setup: function() {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (h) {
                            var t = e.getHead(),
                                l = t.getCustomData("stylesheet");
                            l ? h != l.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? l.$.styleSheet.cssText = h : l.setText(h)) : (h = e.appendStyleText(h), h = new CKEDITOR.dom.element(h.ownerNode || h.owningElement), t.setCustomData("stylesheet",
                                h), h.data("cke-temp", 1))
                        }
                        ...
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function(b) { b.data.getKeystroke() in F && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) });
        ...
        q = function() {
            ...
            function b(c, d) {
                ...
                e = d.range.startPath();
                for (var h = q[h.getName()], l = 0, B = c.getChildren(), z = B.count(), F = -1, m = -1, r = 0, H = e.contains(q.$list); l < z; ++l) e = B.getItem(l), a(e) ? (n = e.getName(), H && n in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (t = !!h[n],
                    "br" != n || !e.data("cke-eol") || l && l != z - 1 || (r = (f = l ? g[l - 1].node : B.getItem(l + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && q.$block[f.getName()]), -1 != F || t || (F = l), t || (m = l), g.push({ isElement: 1, isLineBreak: r, isBlock: e.isBlockBoundary(), hasBlockSibling: f, node: e, name: n, allowed: t }), f = r = 0)) : g.push({ isElement: 0, node: e, allowed: 1 }); - 1 < F && (g[F].firstNotAllowed = 1); - 1 < m && (g[m].lastNotAllowed = 1);
                return g
            }
            ...
            function d(b, c) {
                var e = [],
                    ...
                    g, t = 0,
                    h = q[c],
                    l = !b.is(q.$inline) || b.is("br");
                for (l && e.push(" "); t < p; t++) g =
            ...
            function g(b, c, d, e) {
                ...
                (n = (new CKEDITOR.dom.walker(f)).next()) && a(n) && m[n.getName()] && (p = n.getPrevious()) && a(p) && !p.getParent().equals(b.startContainer) && d.contains(p) && e.contains(n) && n.isIdentical(p) &&
            ...
            var q = CKEDITOR.dtd,
                ...
                x = CKEDITOR.tools.extend({},
                    q.$inline);
            delete x.br;
            return function(m, v, G, D) {
                var I = m.editor,
                    K = !1;
                "unfiltered_html" == v && (v = "html", K = !0);
                if (!D.checkReadOnly()) {
                    var M = (new CKEDITOR.dom.elementPath(D.startContainer, D.root)).blockLimit || D.root;
                    m = { type: v, dontFilter: K, editable: m, editor: I, range: D, blockLimit: M, mergeCandidates: [], zombies: [] };
                    v = m.range;
                    D = m.mergeCandidates;
                    var H, u;
                    ...
                    m.endPath = M = new CKEDITOR.dom.elementPath(v.endContainer);
                    if (!v.collapsed) {
                        var I = M.block || M.blockLimit,
                            C = v.getCommonAncestor();
                        I && !I.equals(C) && !I.contains(C) && v.checkEndOfBlock() && m.zombies.push(I);
                        v.deleteContents() }
                    for (;
                        (u = e(v)) && a(u) && u.isBlockBoundary() && K.contains(u);) v.moveToPosition(u, CKEDITOR.POSITION_BEFORE_END);
                    g(v, m.blockLimit, K, M);
                    ...
                    H = v.createBookmark();
                    (I = H.startNode.getPrevious(c)) && a(I) && f(I) && D.push(I);
                    (I = H.startNode.getNext(c)) && a(I) && f(I) && D.push(I);
                    for (I = H.startNode;
                        (I = I.getParent()) && f(I);) D.push(I);
                    v.moveToBookmark(H);
                    if (H = G) {
                        H = m.range;
                        if ("text" == m.type && m.inlineStylesRoot) { u = m.inlineStylesPeak;
                            v = u.getDocument().createText("{cke-peak}");
                            for (D = m.inlineStylesRoot.getParent(); !u.equals(D);) v = v.appendTo(u.clone()), u = u.getParent();
                        ...
                        if (/^\s+|\s+$/.test(G) && "span" in CKEDITOR.dtd[u]) {
                            ...
                            G = A + G + A }
                        G = m.editor.dataProcessor.toHtml(G, { context: null, fixForBody: !1, protectedWhitespaces: !!A, dontFilter: m.dontFilter, filter: m.editor.activeFilter, enterMode: m.editor.activeEnterMode });
                        ...
                        if ((A = H.startPath().block) && (1 != A.getChildCount() || !A.getBogus())) a: {
                            var w;
                            if (1 ==
                                u.getChildCount() && a(w = u.getFirst()) && w.is(r) && !w.hasAttribute("contenteditable")) { A = w.getElementsByTag("*");
                                H = 0;
                                for (D = A.count(); H < D; H++)
                                    if (v = A.getItem(H), !v.is(x)) break a;
                    ...
                    if (H) {
                        ...
                        var K = m.endPath.elements[0],
                            Y, M = K.getPosition(v),
                            C = !!K.getCommonAncestor(v) && M != CKEDITOR.POSITION_IDENTICAL && !(M & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        v = b(m.dataWrapper, m);
                        for (F(v, w); D < v.length; D++) {
                            M = v[D];
                            if (y = M.isLineBreak) { y = w;
                                E = u;
                                var U = void 0,
                                    aa = void 0;
                                M.hasBlockSibling ? y = 1 : (U = y.startContainer.getAscendant(q.$block, 1)) && U.is({ div: 1, p: 1 }) ? (aa = U.getPosition(E), aa == CKEDITOR.POSITION_IDENTICAL || aa == CKEDITOR.POSITION_CONTAINS ? y = 0 : (E = y.splitElement(U), y.moveToPosition(E, CKEDITOR.POSITION_AFTER_START), y = 1)) : y = 0 }
                            if (y) G = 0 < D;
                            else {
                                y = w.startPath();
                                !M.isBlock && h(m.editor, y.block, y.blockLimit) && (V = l(m.editor)) && (V = H.createElement(V), V.appendBogus(), w.insertNode(V),
                                ...
                                if ((y = w.startPath().block) && !y.equals(N)) {
                                    if (O = y.getBogus()) O.remove(), A.push(y);
                                    N = y }
                                M.firstNotAllowed && (I = 1);
                                if (I && M.isElement) {
                                    y = w.startContainer;
                                    for (E = null; y && !q[y.getName()][M.name];) {
                                        if (y.equals(u)) { y = null;
                                            break }
                                        E = y;
                                        y = y.getParent() }
                                    if (y) E && (J = w.splitElement(E), m.zombies.push(J), m.zombies.push(E));
                                    else {
                                        E = u.getName();
                                        Y = !D;
                                        y = D == v.length - 1;
                                        E = d(M.node, E);
                                        for (var U = [], aa = E.length, ba = 0, da = void 0,
                                                ea = 0, W = -1; ba < aa; ba++) da = E[ba], " " == da ? (ea || Y && !ba || (U.push(new CKEDITOR.dom.text(" ")), W = U.length), ea = 1) : (U.push(da), ea = 0);
                                        y && W == U.length && U.pop();
                                        Y = U
                                    }
                                }
                                if (Y) {
                                    ...
                                    Y = 0 } else w.insertNode(M.node);
                                M.lastNotAllowed && D < v.length - 1 && ((J = C ? K : J) && w.setEndAt(J, CKEDITOR.POSITION_AFTER_START), I = 0);
                                w.collapse()
                            }
                        }
            ...
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (e.blockLimit.is({
                        ...
                        g = function(a) {
                            return !a.equals(h) } } else if (e.block && e.block.is(CKEDITOR.dtd.$listItem) && (f = f.contains(CKEDITOR.dtd.$list), c = c.contains(CKEDITOR.dtd.$list), !f.equals(c))) {
        ...
        E = function() {
            ...
            return {
                    ...
                    merge: function(a, c) {
                        if (a.mergeListBookmark) {
                            var d = a.mergeListBookmark.startNode,
                                ...
                                k = new CKEDITOR.dom.elementPath(e, c);
                            if (a.mergeList) {
                                var g = f.contains(CKEDITOR.dtd.$list),
                                    n = k.contains(CKEDITOR.dtd.$list);
                                g.equals(n) || (n.moveChildren(g), n.remove()) }
                            a.mergeListItems && (f = f.contains(CKEDITOR.dtd.$listItem), k = k.contains(CKEDITOR.dtd.$listItem), f.equals(k) || b(k, d, e));
                            d.remove();
                            e.remove() } }
                },
                block: {
                ...
                table: function() {
                    function a(c) {
                        ...
                        k.guard = function(a, k) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) {
                                var p = "visited_" + (k ? "out" : "in");
                                if (a.getCustomData(p)) return;
                                CKEDITOR.dom.element.setMarker(h, a, p, 1) }
                            if (k && g && a.equals(g)) f = c.clone(), f.setEndAt(g, CKEDITOR.POSITION_BEFORE_END), e.push(f);
                            else if (!k && n && a.equals(n)) f = c.clone(), f.setStartAt(n, CKEDITOR.POSITION_AFTER_START), e.push(f);
                            else {
                                if (p = !k) p = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!g || b(a, g)) && (!n ||
                                    b(a, n));
                    ...
                    return {
                        ...
                        detectRanges: function(e, f) {
                            var k = c(f, e.bookmark),
                                g = k.clone(),
                                h, p, v = k.getCommonAncestor();
                            v.is(CKEDITOR.dtd.$tableContent) && !v.is(d) && (v = v.getAscendant("table", !0));
                            p = v;
                            v = new CKEDITOR.dom.elementPath(k.startContainer,
                                p);
                            p = new CKEDITOR.dom.elementPath(k.endContainer, p);
                            v = v.contains("table");
                            p = p.contains("table");
                            if (v || p) v && p && b(v, p) ? (e.tableSurroundingRange = g, g.setStartAt(v, CKEDITOR.POSITION_AFTER_END), g.setEndAt(p, CKEDITOR.POSITION_BEFORE_START), g = k.clone(), g.setEndAt(v, CKEDITOR.POSITION_AFTER_END), h = k.clone(), h.setStartAt(p, CKEDITOR.POSITION_BEFORE_START), h = a(g).concat(a(h))) : v ? p || (e.tableSurroundingRange = g, g.setStartAt(v, CKEDITOR.POSITION_AFTER_END), k.setEndAt(v, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange =
                                g, g.setEndAt(p, CKEDITOR.POSITION_BEFORE_START), k.setStartAt(p, CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = h ? h : a(k)
                        },
                ...
                autoParagraph: function(a, b) {
                    var c = b.startPath(),
                        d;
                    h(a, c.block, c.blockLimit) && (d = l(a)) && (d = b.document.createElement(d), d.appendBogus(), b.insertNode(d), b.moveToPosition(d,
    ...
    (function() {
        ...
        function d() { x = !0;
            q || (b.call(this), q = CKEDITOR.tools.setTimeout(b, 200, this)) }
        ...
        function g(a) { h(a, !1);
            var b = a.getDocument().createText(A);
        ...
        var C = "function" != typeof window.getSelection,
            u = 1,
            A = CKEDITOR.tools.repeat("​", 7),
            y = new RegExp(A + "( )?", "g"),
            q, x, J = CKEDITOR.dom.walker.invisible(1),
            w = function() {
                function a(b) {
                    return function(a) {
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                ...
                function c() { k.removeListener("mouseup", c);
                ...
                CKEDITOR.env.gecko && g.attachListener(g, "focus",
                    function(a) { a.removeListener();
                        0 !== q && (a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == g.$ && (a = e.createRange(), a.moveToElementEditStart(g), a.select()) }, null, null, -2);
                g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() { q && CKEDITOR.env.webkit && (q = e._.previousActive && e._.previousActive.equals(f.getActive())) && null != e._.previousScrollTop && e._.previousScrollTop != g.$.scrollTop && (g.$.scrollTop = e._.previousScrollTop);
                    e.unlockSelection(q);
                    q = 0 }, null, null, -1);
                g.attachListener(g,
                    "mousedown",
                    function() { q = 0 });
                if (CKEDITOR.env.ie || m) C ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() { e.lockSelection(v);
                    q = 1 }, null, null, -1), g.attachListener(g, "mousedown", function() { q = 0 });
                if (CKEDITOR.env.ie && !m) {
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                            ...
                            l.on("mousedown", function(a) {
                                function b(a) { a = a.data.$;
                                    if (D) {
                                        ...
                                        D.setEndPoint(0 > I.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                                        D.select() } }
                                ...
                                a = a.data;
                                if (a.getTarget().is("html") && a.$.y < l.$.clientHeight && a.$.x < l.$.clientWidth) { D = p.$.createTextRange();
                                    try { D.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {}
                                    I = D.duplicate();
                                    l.on("mousemove", b);
                                    k.on("mouseup", c);
                                    l.on("mouseup", c) }
                        ...
                        if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) l.on("mousedown", function(a) { a.data.getTarget().is("html") && (k.on("mouseup", c), l.on("mouseup", c)) })
                    }
                }
        ...
        if (CKEDITOR.env.webkit) CKEDITOR.on("instanceReady", function(a) {
            ...
            b.on("beforeSetMode", function() { h(b.editable()) }, null, null, -1);
            b.on("getSnapshot", function(a) { a.data && (a.data = l(a.data)) }, b, null, 20);
            b.on("toDataFormat", function(a) { a.data.dataValue = l(a.data.dataValue) }, null, null, 0)
        });
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                var a = C ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (var e = d.children, f, k, g = b.duplicate(), h = 0, l = e.length - 1, v = -1, n, m; h <= l;)
                            if (v = Math.floor((h + l) / 2), f = e[v], g.moveToElementText(f), n = g.compareEndPoints("StartToStart", b), 0 < n) l = v - 1;
                            else if (0 > n) h = v + 1;
                        ...
                        if (-1 == v || v == e.length - 1 && 0 > n) {
                            ...
                            for (d = e.length; 0 < g && 0 < d;) k = e[--d], k.nodeType == CKEDITOR.NODE_TEXT && (m = k, g -= k.nodeValue.length);
                        ...
                        for (; 0 < g;) try {
                            k = f[0 < n ? "previousSibling" : "nextSibling"], k.nodeType == CKEDITOR.NODE_TEXT && (g -= k.nodeValue.length,
                                m = k), f = k
                        } catch (q) {
            ...
            getSelectedText: function() {
                ...
                var b = this.getNative(),
                    b = C ? "Control" == b.type ? "" : b.createRange().text : b.toString();
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        if (l) this.fake(l);
                            ...
                            if (C) {
                                q = CKEDITOR.dom.walker.whitespaces(!0);
                                m = /\ufeff|\u00a0/;
                                ...
                                if ((c = l.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT &&
                                    c.getName() in E && (!c.is("a") || !c.getText())) try { y = c.$.createControlRange();
                                    y.addElement(c.$);
                                    y.select();
                                    return } catch (w) {}
                                ...
                                b = y.startNode;
                                a || (f = y.endNode);
                                y = l.document.$.body.createTextRange();
                                y.moveToElementText(b.$);
                                y.moveStart("character", 1);
                                f ? (m = l.document.$.body.createTextRange(),
                                    m.moveToElementText(f.$), y.setEndPoint("EndToEnd", m), y.moveEnd("character", -1)) : (r = b.getNext(q), u = b.hasAscendant("pre"), r = !(r && r.getText && r.getText().match(m)) && (u || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")), u = l.document.createElement("span"), u.setHtml("\x26#65279;"), u.insertBefore(b), r && l.document.createText("﻿").insertBefore(b));
                                l.setStartBefore(b);
                                b.remove();
                                a ? (r ? (y.moveStart("character", -1), y.select(), l.document.$.selection.clear()) : y.select(), l.moveToPosition(u, CKEDITOR.POSITION_BEFORE_START),
                                    u.remove()) : (l.setEndBefore(f), f.remove(), y.select())
                            } else {
                                f = this.getNative();
                                if (!f) return;
                                this.removeAllRanges();
                                for (y = 0; y < a.length; y++) {
                                    if (y < a.length - 1 && (r = a[y], u = a[y + 1], m = r.clone(), m.setStart(r.endContainer, r.endOffset), m.setEnd(u.startContainer, u.startOffset), !m.collapsed && (m.shrink(CKEDITOR.NODE_ELEMENT, !0), l = m.getCommonAncestor(), m = m.getEnclosedNode(), l.isReadOnly() || m && m.isReadOnly()))) { u.setStart(r.startContainer, r.startOffset);
                                        a.splice(y--, 1);
                                        continue }
                                    l = a[y];
                                    ...
                                    try { u.setEnd(l.endContainer.$, l.endOffset) } catch (v) {
                                        if (0 <= v.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) l.collapse(1), u.setEnd(l.endContainer.$, l.endOffset);
                                        else throw v; }
                                    f.addRange(u)
                                }
                            }
            ...
            removeAllRanges: function() {
                if (this.getType() != CKEDITOR.SELECTION_NONE) {
                    var a = this.getNative();
                    try { a && a[C ? "empty" : "removeAllRanges"]() } catch (b) {}
                    this.reset() } }
        }
    })();
    "use strict";
    ...
    (function() {
        ...
        function b(c) {
            ...
            if (c.collapsed) f = J(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
                ...
                var g = this.element,
                    k = this._.definition,
                    l, h = k.ignoreReadonly,
                    m = h || k.includeReadonly;
                null ==
                ...
                if (!h) {
                    var w = c.getCommonAncestor(),
                        h = a(p, w),
                        w = a(r, w);
                    h && (u = h.getNextSourceNode(!0));
                    w && (r = w) }
                for (u.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (u = 0); u;) {
                    h = !1;
                    if (u.equals(r)) u = null, h = !0;
                    else {
                        var A = u.type == CKEDITOR.NODE_ELEMENT ? u.getName() : null,
                            w = A && "false" == u.getAttribute("contentEditable"),
                            x = A &&
                            u.getAttribute("data-nostyle");
                        if (A && u.data("cke-bookmark")) { u = u.getNextSourceNode(!0);
                            continue }
                        if (w && m && CKEDITOR.dtd.$block[A])
                            for (var C = u, z = e(C), B = void 0, E = z.length, F = 0, C = E && new CKEDITOR.dom.range(C.getDocument()); F < E; ++F) {
                                var B = z[F],
                                    L = CKEDITOR.filter.instances[B.data("cke-filter")];
                                if (L ? L.check(this) : 1) C.selectNodeContents(B), b.call(this, C) }
                        z = A ? !n[A] || x ? 0 : w && !m ? 0 : d(u, r, k, Q) : 1;
                        if (z)
                            if (B = u.getParent(), z = k, E = g, F = l, !B || !(B.getDtd() || CKEDITOR.dtd.span)[E] && !F || z.parentRule && !z.parentRule(B)) h = !0;
                            else {
                                if (t ||
                                    A && CKEDITOR.dtd.$removeEmpty[A] && (u.getPosition(r) | Q) != Q || (t = c.clone(), t.setStartBefore(u)), A = u.type, A == CKEDITOR.NODE_TEXT || w || A == CKEDITOR.NODE_ELEMENT && !u.getChildCount()) {
                                    for (var A = u, R;
                                        (h = !A.getNext(H)) && (R = A.getParent(), n[R.getName()]) && d(R, p, k, P);) A = R;
                                    t.setEndAfter(A) }
                            }
                        else h = !0;
                    ...
                    if (h && t && !t.collapsed) {
                        for (var h = J(this, f), w = h.hasAttributes(), x = t.getCommonAncestor(), A = {}, z = {}, B = {}, E = {}, W, T, ca; h && x;) {
                            if (x.getName() == g) {
                                for (W in k.attributes) !E[W] && (ca = x.getAttribute(T)) &&
                                    (h.getAttribute(W) == ca ? z[W] = 1 : E[W] = 1);
                                for (T in k.styles) !B[T] && (ca = x.getStyle(T)) && (h.getStyle(T) == ca ? A[T] = 1 : B[T] = 1)
                            }
                            x = x.getParent()
                        }
                        for (W in z) h.removeAttribute(W);
                        for (T in A) h.removeStyle(T);
                        w && !h.hasAttributes() && (h = null);
                        h ? (t.extractContents().appendTo(h), t.insertNode(h), y.call(this, h), h.mergeSiblings(), CKEDITOR.env.ie || h.$.normalize()) : (h = new CKEDITOR.dom.element("span"), t.extractContents().appendTo(h), t.insertNode(h), y.call(this, h), h.remove(!0));
                        t = null
                    }
                }
                c.moveToBookmark(q);
            ...
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, g = 0, h; g < e.elements.length && (h = e.elements[g]) && h != e.block && h != e.blockLimit; g++)
                    if (this.checkElementRemovable(h)) {
                        var l;
                        a.collapsed && (a.checkBoundaryOfElement(h, CKEDITOR.END) || (l = a.checkBoundaryOfElement(h, CKEDITOR.START))) ? (f = h, f.match = l ? "start" : "end") : (h.mergeSiblings(), h.is(this.element) ? A.call(this, h) : q(h, k(this)[h.getName()])) }
                if (f) {
                    h = d;
                    for (g = 0;; g++) {
                        l = e.elements[g];
                ...
                var m = c.endNode,
                    n = this;
                b();
                for (e = d; !e.equals(m);) f = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? A.call(this, e) : q(e, k(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), e = f }
            a.moveToBookmark(c);
        ...
        function r(a, b) {
            ...
            if (d) {
                var c = b,
                    k;
                (k = c.getPrevious(R)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("pre") && (d = C(k.getHtml(), /\n$/, "") + "\n\n" + C(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" :
        ...
        function y(a) {
            for (var b = k(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || A.call(this, d, !0);
            for (var f in b)
                if (f != this.element)
        ...
        function E(a,
            b) {
            for (var c in a) a[c] = a[c].replace(L, function(a, c) {
                return b[c] }) }
        ...
        var z = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 },
            B = { a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1 },
            F = /\s*(?:;\s*|$)/,
            L = /#\((.+?)\)/g,
        ...
        CKEDITOR.style = function(a, b) {
            ...
            b && (a = CKEDITOR.tools.clone(a), E(a.attributes, b), E(a.styles, b));
            c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() : a.element : "*";
            this.type = a.type || (z[c] ? CKEDITOR.STYLE_BLOCK : B[c] ? CKEDITOR.STYLE_OBJECT :
        ...
        CKEDITOR.style.prototype = {
            ...
            applyToRange: function(a) { this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? l : this.type == CKEDITOR.STYLE_OBJECT ? g : null;
                return this.applyToRange(a) },
            removeFromRange: function(a) { this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? m : this.type == CKEDITOR.STYLE_OBJECT ? h : null;
        ...
        CKEDITOR.style.getStyleText = function(a) {
            ...
            for (var e in b) {
                var f = b[e],
                    g = (e + ":" + f).replace(F, ";"); "inherit" == f ? d += g : c += g }
            ...
            do
                if (m.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!h && (r = m.getName(),
                        ...
                        if (r = !g && "div" == r) { a: { r = m.getChildren();
                                for (var f = 0, C = r.count(); f < C; f++) {
                                    var u = r.getItem(f);
    ...
    */
    ...
    (function() {
        function r(b, a, c) { a.type || (a.type = "auto");
        ...
        function y(b) {
            function a() {
                ...
                if (CKEDITOR.plugins.clipboard.isCustomCopyCutSupported) {
                    var d = function(a) { b.readOnly && "cut" == a.name || n.initPasteDataTransfer(a, b);
                        a.data.preventDefault() };
                    a.on("copy",
                        d);
                    a.on("cut", d);
                ...
                a.on(n.mainPasteEvent, function(b) { "beforepaste" == n.mainPasteEvent && p || k(b) });
                "beforepaste" == n.mainPasteEvent && (a.on("paste", function(a) { v || (e(), a.data.preventDefault(), k(a), f("paste") || b.openDialog("paste")) }), a.on("contextmenu", g, null, null, 0), a.on("beforepaste", function(b) {!b.data || b.data.$.ctrlKey || b.data.$.shiftKey || g() }, null, null, 0));
                a.on("beforecut", function() {!p && h(b) });
                var c;
                a.attachListener(CKEDITOR.env.ie ?
                    a : b.document.getDocumentElement(), "mouseup",
                    function() { c = setTimeout(function() { t() }, 0) });
                b.on("destroy", function() { clearTimeout(c) });
                a.on("keyup", t)
            }
            ...
            function c(a) {
                return { type: a, canUndo: "cut" == a, startDisabled: !0, fakeKeystroke: "cut" == a ? CKEDITOR.CTRL + 88 : CKEDITOR.CTRL + 67, exec: function() { "cut" == this.type && h();
                        ...
                        else try { a = b.document.$.execCommand(d, !1, null) } catch (c) { a = !1 }
            ...
            function d() {
                return {
                    ...
                    exec: function(b, a) {
                        var d = this,
                            c = function(a, c) { a && r(b, a, !!c);
                                b.fire("afterCommandExec", { name: "paste", command: d, returnValue: !!a }) }; "string" == typeof a ? c({ dataValue: a, method: "paste", dataTransfer: n.initPasteDataTransfer() }, 1) : b.getClipboardData(c) }
                }
            }
            ...
            function h() {
                if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
                    var a = b.getSelection(),
                        d, c, e;
                    a.getType() == CKEDITOR.SELECTION_ELEMENT && (d = a.getSelectedElement()) && (c = a.getRanges()[0], e = b.document.createText(""), e.insertBefore(d), c.setStartBefore(e), c.setEndAfter(d), a.selectRanges([c]), setTimeout(function() { d.getParent() && (e.remove(), a.selectElement(d)) }, 0)) } }
            ...
            function l(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    m.setStyles({ position: "absolute", top: c.getScrollPosition().y - k + 10 + "px", width: "1px", height: Math.max(1, c.getViewPaneSize().height - 20) + "px", overflow: "hidden", margin: 0, padding: 0 });
                    ...
                    var t = k.select();
                    CKEDITOR.env.ie && (q = e.once("blur", function() { b.lockSelection(t) }));
            ...
            function k(a) {
                ...
                c && n.canClipboardApiBeTrusted(d.dataTransfer, b) ? (a.data.preventDefault(), setTimeout(function() { r(b, d) }, 0)) : l(a, function(a) { d.dataValue = a.replace(/<span[^>]+data-cke-bookmark[^<]*?<\/span>/ig, "");
                    c && r(b, d) }) }
            ...
            (function() {
                ...
                b.contextMenu && b.contextMenu.addListener(function(b, a) { w = a.getRanges()[0].checkReadOnly();
            ...
            b.getClipboardData = function(a, d) {
                ...
                b.on("beforePaste", function(a) { a.removeListener();
                    q = !0;
                    g = a.data.type }, null, null, 1E3);
                !1 === z() && (b.removeListener("paste", c), q && b.fire("pasteDialog",
                    f) ? (b.on("pasteDialogCommit", e), b.on("dialogHide", function(a) { a.removeListener();
                    a.data.removeListener("pasteDialogCommit", e);
                    setTimeout(function() { k || d(null) }, 10) })) : d(null))
            }
        }
        ...
        function F(b) {
            ...
            b.on("contentDom", function() {
                ...
                function e(a, d, c) {
                    ...
                    d && (e.dragRange = d);
                    c && (e.dropRange = c);!1 === b.fire(a.name, e) && a.data.preventDefault() }
                ...
                f.attachListener(b, "dragstart", function(d) { a.initDragDataTransfer(d, b) }, null, null, 2);
            ...
            init: function(b) {
                ...
                b.on("paste", function(a) {
                    ...
                    CKEDITOR.env.ie ? b = b.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g, function(b, f) {
                        return f.toLowerCase() in c ? (a.data.preSniffing = "html", "\x3c" + f) : b }) : CKEDITOR.env.webkit ? b = b.replace(/<\/(\w+)><div><br><\/div>$/, function(b, f) {
                        return f in c ? (a.data.endsWithEOL = 1, "\x3c/" + f + "\x3e") : b }) : CKEDITOR.env.gecko && (b = b.replace(/(\s)<br>$/, "$1"));
                    a.data.dataValue = b
                }, null, null, 3);
                b.on("paste", function(a) {
                        a = a.data;
                        var e = a.type,
                            g = a.dataValue,
                            f, h = b.config.clipboard_defaultContentType ||
                            "html",
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            for (var h = !1, l = 0; 20 > l &&
                                !h; l++) {
                                if (!h) try { c.moveToPoint(d, e - l), h = !0 } catch (p) {}
                                if (!h) try { c.moveToPoint(d, e + l), h = !0 } catch (q) {} }
                            if (h) {
    ...
    CKEDITOR.plugins.add("colorbutton", {
        ...
        init: function(d) {
            function r(a, c, e, g, k) {
                var n = new CKEDITOR.style(l["colorButton_" + c + "Style"]),
                ...
                d.ui.add(a, CKEDITOR.UI_PANELBUTTON, {
                    ...
                    onOpen: function() {
                        ...
                        if (a) {
                            ...
                            !1 !== l.colorButton_enableAutomatic && this._.panel._.iframe.getFrameDocument().getById(m).setStyle("background-color", b);
                            return b
                        }
                    }
                })
            ...
            function w(a, c, e) {
                var g = [],
                    ...
                    n = d.plugins.colordialog && !1 !== l.colorButton_enableMore,
                    m = k.length + (n ? 2 : 1),
                    p = CKEDITOR.tools.addFunction(function(b,
                        c) {
                        function e(a) { this.removeListener("ok", e);
                            this.removeListener("cancel", e); "ok" == a.name && f(this.getContentElement("picker", "selectedColor").getValue(), c) }
                        var f = arguments.callee;
                        if ("?" == b) d.openDialog("colordialog", function() { this.on("ok", e);
                            this.on("cancel", e) });
                        else {
                            d.focus();
                            a.hide();
                            d.fire("saveSnapshot");
                            d.removeStyle(new CKEDITOR.style(l["colorButton_" + c + "Style"], { color: "inherit" }));
                            if (b) {
                                var g = l["colorButton_" + c + "Style"];
                                g.childRule = "back" == c ? function(a) {
                ...
                !1 !== l.colorButton_enableAutomatic && g.push('\x3ca class\x3d"cke_colorauto" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', h.auto, '" onclick\x3d"CKEDITOR.tools.callFunction(', p, ",null,'", c, "');return false;\" href\x3d\"javascript:void('", h.auto, '\')" role\x3d"option" aria-posinset\x3d"1" aria-setsize\x3d"', m, '"\x3e\x3ctable role\x3d"presentation" cellspacing\x3d0 cellpadding\x3d0 width\x3d"100%"\x3e\x3ctr\x3e\x3ctd\x3e\x3cspan class\x3d"cke_colorbox" id\x3d"',
                    e, '"\x3e\x3c/span\x3e\x3c/td\x3e\x3ctd colspan\x3d7 align\x3dcenter\x3e', h.auto, "\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/a\x3e");
                g.push('\x3ctable role\x3d"presentation" cellspacing\x3d0 cellpadding\x3d0 width\x3d"100%"\x3e');
                for (e = 0; e < k.length; e++) {
                    0 === e % 8 && g.push("\x3c/tr\x3e\x3ctr\x3e");
                    var b = k[e].split("/"),
                        f = b[0],
                        q = b[1] || f;
                    b[1] || (f = "#" + f.replace(/^(.)(.)(.)$/, "$1$1$2$2$3$3"));
                ...
                n && g.push('\x3c/tr\x3e\x3ctr\x3e\x3ctd colspan\x3d8 align\x3dcenter\x3e\x3ca class\x3d"cke_colormore" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', h.more, '" onclick\x3d"CKEDITOR.tools.callFunction(',
                    p, ",'?','", c, "');return false;\" href\x3d\"javascript:void('", h.more, "')\"", ' role\x3d"option" aria-posinset\x3d"', m, '" aria-setsize\x3d"', m, '"\x3e', h.more, "\x3c/a\x3e\x3c/td\x3e");
            ...
            if (!CKEDITOR.env.hc) {
                ...
                var u = {},
                    v = d.config.colorButton_normalizeBackground;
                if (void 0 === v || v) u.contentTransformations = [
                    [{
                        element: "span",
                        left: function(a) {
                        ...
                        right: function(a) {
                            var c = (new CKEDITOR.style(d.config.colorButton_backStyle, { color: a.styles.background })).getDefinition();
                            a.name = c.element;
                            a.styles = c.styles;
    ...
    (function() {
        ...
        CKEDITOR.menuItem = CKEDITOR.tools.createClass({
            $: function(a,
                b, d) { CKEDITOR.tools.extend(this, d, { order: 0, className: "cke_menubutton__" + b });
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("copyformatting", {
            ...
            init: function(a) {
                ...
                a.on("contentDom", function() {
                    ...
                    e.attachListener(b, "mouseup", function(b) { q(b) && a.execCommand("applyFormatting") });
                ...
                a.copyFormatting.on("applyFormatting", function(e) {
                    if (!e.data.preventFormatStripping) {
                        var d = e.data.range,
                            ...
                            g = b._determineContext(d),
                            f, h;
                        if (a.copyFormatting._isContextAllowed(g))
                            for (h = 0; h < c.length; h++) g = c[h], f = d.createBookmark(), -1 === m(b.preservedElements, g.element) ? CKEDITOR.env.webkit && !CKEDITOR.env.chrome ? c[h].removeFromRange(e.data.range, e.editor) : c[h].remove(e.editor) : t(g.element, e.data.styles) && b._removeStylesFromElementInRange(d,
        ...
        CKEDITOR.plugins.copyformatting = {
            ...
            _extractStylesFromElement: function(a, b) {
                ...
                do
                    if (b.type === CKEDITOR.NODE_ELEMENT && !b.hasAttribute("data-cke-bookmark") &&
                        (e.element = b, a.copyFormatting.fire("extractFormatting", e, a) && e.styleDef && d.push(new CKEDITOR.style(e.styleDef)), b.getName && -1 !== m(CKEDITOR.plugins.copyformatting.breakOnElements, b.getName()))) break;
            ...
            _removeStylesFromElementInRange: function(a, b) {
                for (var e = -1 !==
                        m(["ol", "ul", "table"], b), d = new CKEDITOR.dom.walker(a), c; c = d.next();)
            ...
            _getSelectedWordOffset: function(a) {
                ...
                function d(a, c) {
                    ...
                    do {
                        for (p = b(f, c); !p && f.getParent();) { f = f.getParent();
                            if (-1 !== m(h, f.getName())) { l = k = !0;
                                break }
                            p = b(f, c) }
                        if (p && p.getName && -1 !== m(h, p.getName())) { k = !0;
                            break }
                    ...
                    if (k) c ? n = 0 : (g = /([\.\b]*$)/, n = (l = g.exec(h)) ? l.index : h.length);
                    else if (c && (n +=
                ...
                for (g = e(h); null != (f = c.exec(g));)
                    if (f.index + f[0].length >= a.startOffset) return a = f.index, c = f.index + f[0].length, 0 === f.index && (f = d(h, !0), k = f.node, a = f.offset), c >= g.length && (g = d(h), l = g.node, c = g.offset), { startNode: k, startOffset: a, endNode: l, endOffset: c };
                return null
            },
            ...
            _applyStylesToTextContext: function(a, b, e) {
                ...
                for (g = 0; g < e.length; g++)
                    if (b = e[g], -1 === m(d.excludedElementsFromInlineTransform, b.element)) {
                        if (-1 !== m(d.elementsForInlineTransform, b.element))
                            for (b.element = b._.definition.element = "span", f = 0; f < c.length; f++) b._.definition.attributes[c[f]] && delete b._.definition.attributes[c[f]];
                        b.apply(a) }
            },
            ...
            _applyStylesToTableContext: function(a, b, e) {
                ...
                for (g = 0; g < e.length; g++) c = e[g], -1 !== m(["table", "tr"], c.element) ? k(b,
                    c.element,
                    function(a) { c.applyToObject(a) }) : -1 !== m(["td", "th"], c.element) ? k(b, { td: 1, th: 1 }, function(a) { d(a, c) }) : -1 !== m(["thead", "tbody"], c.element) ? k(b, { thead: 1, tbody: 1 }, function(a) { d(a, c) }) : CKEDITOR.plugins.copyformatting._applyStylesToTextContext(a, b, [c])
            },
        ...
        function n(a, c, k, d, q, n, u, w) {
            ...
            for (var m = {}, g = 0; g < f.length; g++) {
                ...
                if (l) {
                    ...
                    m[p]._.definition.name = p } else f.splice(g--, 1) }
            a.ui.addRichCombo(c, {
                label: d.label,
                title: d.panelTitle,
                toolbar: "styles," + w,
                ...
                init: function() { this.startGroup(d.panelTitle);
                ...
                onRender: function() {
                    a.on("selectionChange", function(b) {
                        ...
                        for (var d = 0, f; d < b.length; d++) {
                            f = b[d];
                            for (var e in m)
                                if (m[e].checkElementMatch(f, !0, a)) { e != c && this.setValue(e);
                                    return }
                        }
                        this.setValue("", n)
                    }, this)
            ...
            init: function(c) {
                ...
                c.ui.addRichCombo("Styles", {
                    ...
                    onClick: function(b) { c.focus();
                        ...
                        c.fire("saveSnapshot") },
                    onRender: function() { c.on("selectionChange", function(b) {
                            var a = this.getValue();
                            b = b.data.path.elements;
                            for (var h = 0, d = b.length, e; h < d; h++) { e = b[h];
                                for (var g in f)
                                    if (f[g].checkElementRemovable(e, !0, c)) { g != a && this.setValue(g);
                                        return } }
                            this.setValue("") }, this) },
                    onOpen: function() {
                        var b =
                            c.getSelection().getSelectedElement(),
                            b = c.elementPath(b),
                            a = [0, 0, 0, 0];
                        this.showAll();
                        this.unmarkAll();
