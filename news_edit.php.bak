...
<div class="container">
	<form action="news_update.php" method="post">
		标题：<input type="text" name="title" size="60" value="<?php echo $news['title']?>"><br/>
		内容：<textarea cols="60" rows="16" name="content" class="ckeditor"><?php echo $news['content']?></textarea><br/>
