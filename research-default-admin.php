				...
				<?php
				 ...
				 ?>
					  <li class="list-group-item">
					    <span class="badge"><?php echo $row['add_time']?><a href="research_delete-default.php?suggestion_noimg_id=<?php echo $row['suggestion_noimg_id']?>" class="right"><i class="glyphicon glyphicon-trash"></i></a></span>
